...
| ---: | :--- | :--- | :--- |
| 0 | :wave: Intro to unlearning and FL | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/00-intro-ul-fl/intro-unlearning.ipynb "Click to open in Google Colab") [intro-unlearning.ipynb](/notebooks/00-intro-ul-fl/intro-unlearning.ipynb) <br /> [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/00-intro-ul-fl/intro-fl.ipynb "Click to open in Google Colab") [intro-fl.ipynb](/notebooks/00-intro-ul-fl/intro-fl.ipynb) <br /> [:computer:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/00-intro-ul-fl/code-amnesiac-ml.ipynb "Click to open in Google Colab") [code-amnesiac-ml.ipynb](/notebooks/00-intro-ul-fl/code-amnesiac-ml.ipynb) <br /> [:computer:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/00-intro-ul-fl/code-flwr.ipynb "Click to open in Google Colab") [code-flwr.ipynb](/notebooks/00-intro-ul-fl/code-flwr.ipynb) | [^ngu+22][^dan21][^pit+19][^st17][^cy15][^bou+21][^zha+21][^mcm+17][^gng21] |
| 1 | :mag: More on unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/01-ul-more/unlearning-definition.ipynb "Click to open in Google Colab") [unlearning-definition.ipynb](/notebooks/01-ul-more/unlearning-definition.ipynb) <br /> [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/01-ul-more/unlearning-framework.ipynb "Click to open in Google Colab") [unlearning-framework.ipynb](/notebooks/01-ul-more/unlearning-framework.ipynb)  | [^ngu+22] |
| 2 | :bridge_at_night: Unlearning in FL | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/02-un-in-fl/ul-in-fl.ipynb "Click to open in Google Colab") [ul-in-fl.ipynb](/notebooks/02-un-in-fl/ul-in-fl.ipynb) | [^ngu+22][^mcm+17] |
| 3 | :tada: FedEraser: 1st attempt | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/03-liu%2B21a/federaser.ipynb "Click to open in Google Colab") [federaser.ipynb](/notebooks/03-liu+21a/federaser.ipynb) <br /> [:computer:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/03-liu%2B21a/code-federaser.ipynb "Click to open in Google Colab") [code-federaser.ipynb](/notebooks/03-liu+21a/code-federaser.ipynb) | [^liu+21a] |
| 4 | :deciduous_tree: RevFRF: federated unlearning in RF | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/04-liu%2B21b/revfrf.ipynb "Click to open in Google Colab") [revfrf.ipynb](/notebooks/04-liu+21b/revfrf.ipynb) | [^liu+21b] |
| 5 | :coin: Bayesian variational FL and unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/05-gsk21/bayesian-variational.ipynb "Click to open in Google Colab") [bayesian-variational.ipynb](notebooks/05-gsk21/bayesian-variational.ipynb) | [^gsk21] |
| 6 | :test_tube: Federated unlearing with distillation | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/06-wzm22/distillation.ipynb "Click to open in Google Colab") [distillation.ipynb](/notebooks/06-wzm22/distillation.ipynb) | [^wzm22] |
| 7 | :scissors: Federated unlearning with class-discriminative pruning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/07-wan%2B22/channel-prune.ipynb "Click to open in Google Colab") [channel-prune.ipynb](notebooks/07-wan+22/channel-prune.ipynb) | [^wan+22] |
| 8 | :weight_lifting: Federated unlearing with rapid retraining | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/08-liu%2B22/rapid-retrain.ipynb "Click to open in Google Colab") [rapid-retrain.ipynb](/notebooks/08-liu+22/rapid-retrain.ipynb) <br /> [:computer:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/08-liu%2B22/code-rapid-retrain.ipynb "Click to open in Google Colab") [code-rapid-retrain.ipynb](/notebooks/08-liu+22/code-rapid-retrain.ipynb) | [^liu+22] |
| 9 | :dizzy: Forget-SVGD: particle-based Bayesian federated unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/09-gon%2B22/forget-svgd.ipynb "Click to open in Google Colab") [forget-svgd.ipynb](/notebooks/09-gon+22/forget-svgd.ipynb) | [^gon+22] |
| 10 | :heavy_check_mark: VeriFi: Verifiable federated unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/10-gao%2B22/verifi.ipynb "Click to open in Google Colab") [verifi.ipynb](/notebooks/10-gao+22/verifi.ipynb) | [^gao+22] |
| 11 | :no_good: Client opt-out | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/11-hal%2B22/opt-out-unlearning.ipynb "Click to open in Google Colab") [opt-out-unlearning.ipynb](/notebooks/11-hal+22/opt-out-unlearning.ipynb) | [^hal+22] |
| 12 | :pill: FedRecover: recover from poison | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/12-cao%2B22/fedrecover.ipynb "Click to open in Google Colab") [fedrecover.ipynb](/notebooks/12-cao+22/fedrecover.ipynb) | [^cao+22] |
| 13 | :busts_in_silhouette: Unlearning of federated clusters | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/13-pan%2B22/unlearning-cluster.ipynb "Click to open in Google Colab") [unlearning-cluster.ipynb](/notebooks/13-pan+22/unlearning-cluster.ipynb) | [^pan+22] |
| 14 | :rocket: Unlearning in federated optimization | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/14-fra%2B22/sequential-informed.ipynb "Click to open in Google Colab") [sequential-informed.ipynb](/notebooks/14-fra+22/sequential-informed.ipynb) | [^fra+22] |
| 15 | :balance_scale: Compare class, client, sample unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/15-wu%2B22/federated-unlearning.ipynb "Click to open in Google Colab") [federated-unlearning.ipynb](/notebooks/15-wu+22/federated-unlearning.ipynb) | [^wu+22] |
| 16 | :milky_way: Subspace-based federated unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/16-li%2B23/subspace.ipynb "Click to open in Google Colab") [subspace.ipynb](/notebooks/16-li+23/subspace.ipynb) | [^li+23] |
| 17 | :bar_chart: Federated knowledge graph embedding learning and unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/17-zlh23/heterogeneous-kg-embedding.ipynb "Click to open in Google Colab") [heterogeneous-kg-embedding.ipynb](/notebooks/17-zlh23/heterogeneous-kg-embedding.ipynb) | [^zlh23] |
| 18 | :+1: Federated unlearning for on-device recommendation | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/18-yua%2B23/on-device-recommend.ipynb "Click to open in Google Colab") [on-device-recommend.ipynb](/notebooks/18-yua+23/on-device-recommend.ipynb) | [^yua+23] |
| 19 | :link: Knot: asynchronous federated unlearning | [:book:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/19-sl23/knot.ipynb "Click to open in Google Colab") [knot.ipynb](/notebooks/19-sl23/knot.ipynb) <br /> [:computer:](https://colab.research.google.com/github/vicw0ng-hk/feul/blob/master/notebooks/19-sl23/code-knot.ipynb "Click to open in Google Colab") [code-knot.ipynb](/notebooks/19-sl23/code-knot.ipynb) | [^sl23] |
...
[^sl23]: N. Su and B. Li, “Asynchronous Federated Unlearning,” Proceedings of International Conference on Computer Communications (INFOCOM), 2023. [[Paper](https://ningxinsu.github.io/projects/infocom23/)]
